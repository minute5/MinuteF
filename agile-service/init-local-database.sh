...
java -Dspring.datasource.url="jdbc:mysql://106.14.187.2:3306/agile-test-manager-service?useUnicode=true&characterEncoding=utf-8&useSSL=false" \
 -Dspring.datasource.username=root \
 -Dspring.datasource.password=7414 \
