...
//import TestStatusService;
//import io.choerodon.test.manager.domain.service.ITestCycleCaseService;
//import TestCycleCaseE;
//import TestCycleCaseHistoryE;
//import TestStatusE;
...
//
//	@Around("execution(* TestCycleCaseService.changeOneCase(..)) && args(testCycleCaseDTO,projectId)")
...
//	}
//
//	@Around("execution(* TestCycleCaseService.delete(..)) && args(cycleCaseId,projectId)")
